...
const securityHeaders = [
  ...
  },
  {
    ...
    value: `
      ...
      font-src 'self' data:;
      connect-src 'self' https://auofolcuctimbrevhiev.supabase.co https://vercel.live wss://ws-us3.pusher.com https://*.google-analytics.com https://*.analytics.google.com https://analytics.google.com https://www.google.com https://*.googletagmanager.com https://*.g.doubleclick.net https://stats.g.doubleclick.net;
